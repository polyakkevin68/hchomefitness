...
| CI adatbázis-környezet | Első távoli futás: teszthiba; javítás feltöltve, új futás ellenőrzendő | A GitHub Actions PostgreSQL 17 szolgáltatást és migrációt használ. Az első CI futás lintje, típusellenőrzése és migrációja sikerült; a rendelési PostgreSQL-teszt a `helyi-fejlesztes` jogidokumentum-verziók hiánya miatt bukott. A workflow a két tesztértéket kizárólag a tesztlépésnek adja át. A célzott helyi PostgreSQL-próba 5/5 teszttel sikeres; az új távoli futás még nem igazolt. |
