...
- A tulajdonos pontosította a GitHub-felhasználónevet: a helyes cím `polyakkevin68/hchomefitness`. Két commit feltöltve, a `.env` kimaradt. Az első CI lintje, típusellenőrzése és migrációja sikerült, de a rendelési PostgreSQL-teszt a két tesztjogi verziókörnyezet-változó hiányán elbukott. A workflow most ezeket kizárólag a tesztlépésnek adja át; az új távoli futás ellenőrzése folyamatban.
